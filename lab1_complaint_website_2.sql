...
--
-- Database: `online_complaint_website`
--
...
--
-- Table structure for table `manage_complaint`
--

CREATE TABLE `manage_complaint` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `manage_complaint`
--
ALTER TABLE `manage_complaint`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `manage_complaint`
--
ALTER TABLE `manage_complaint`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `manage_complaint`
--
ALTER TABLE `manage_complaint`
  ADD CONSTRAINT `manage_complaint_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaint_registration` (`id`);
...
ALTER TABLE `manage_employee`
  ...
  ADD CONSTRAINT `manage_employee_ibfk_2` FOREIGN KEY (`complaint_id`) REFERENCES `complaint_registration` (`id`);
COMMIT;
